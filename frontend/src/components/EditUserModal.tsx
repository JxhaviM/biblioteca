...
const EditUserModal: React.FC<EditUserModalProps> = ({
  ...
  // password generation handled via alert; no local state needed
  ...
  const getRolePermissions = (role: 'superadmin' | 'admin' | 'user') => {
    const permissions = {
      superadmin: [
        { category: '👥 Usuarios', permissions: ['Crear', 'Ver', 'Editar', 'Eliminar', 'Gestionar todos'] },
        { category: '👤 Personas', permissions: ['Crear', 'Ver', 'Editar', 'Eliminar', 'Gestionar'] },
        { category: '📚 Libros', permissions: ['Crear', 'Ver', 'Editar', 'Eliminar', 'Gestionar inventario'] },
        { category: '📖 Préstamos', permissions: ['Crear', 'Ver', 'Aprobar', 'Cancelar', 'Gestionar'] },
        { category: '📝 Asistencia', permissions: ['Registrar', 'Ver', 'Editar', 'Reportes'] },
        { category: '🏢 Espacios', permissions: ['Ver', 'Aprobar reservas', 'Gestionar'] },
        { category: '📊 Reportes', permissions: ['Ver todos', 'Exportar', 'Estadísticas completas'] },
        { category: '🔐 Permisos', permissions: ['Ver', 'Gestionar roles', 'Gestionar permisos'] },
        { category: '⚙️ Sistema', permissions: ['Configuración', 'Respaldos', 'Auditoría completa'] }
      ],
      admin: [
        { category: '👥 Usuarios', permissions: ['Ver usuarios regulares', 'Editar usuarios', 'Crear cuentas'] },
        { category: '👤 Personas', permissions: ['Crear', 'Ver', 'Editar', 'Gestionar'] },
        { category: '📚 Libros', permissions: ['Crear', 'Ver', 'Editar', 'Gestionar inventario'] },
        { category: '📖 Préstamos', permissions: ['Crear', 'Ver', 'Aprobar', 'Gestionar'] },
        { category: '📝 Asistencia', permissions: ['Registrar', 'Ver', 'Reportes'] },
        { category: '🏢 Espacios', permissions: ['Ver', 'Gestionar reservas'] },
        { category: '📊 Reportes', permissions: ['Ver', 'Exportar', 'Estadísticas'] }
      ],
      user: [
        { category: '📚 Libros', permissions: ['Ver catálogo', 'Buscar'] },
        { category: '📖 Préstamos', permissions: ['Solicitar', 'Ver mis préstamos'] },
        { category: '🏢 Espacios', permissions: ['Ver disponibilidad', 'Reservar'] },
        { category: '👤 Perfil', permissions: ['Ver mi perfil', 'Editar contacto'] }
      ]
    };
  ...
  // new password returned in response.data.newPassword (shown via alert)
  ...
  <form onSubmit={handleSubmit} className="space-y-3">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
            <h3 className="col-span-full text-base font-semibold text-gray-800 border-b pb-2">Datos Personales</h3>
            <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <h3 className="col-span-full text-base font-semibold text-gray-800 border-b pb-2">
              Información de Contacto
            </h3>
              ...
              {editableFields.role && (
                <div className="col-span-full">
                  ...
                  >
                    ...
                    <span>Ver permisos de este rol</span>
                  </button>
                  ...
                  {showPermissions && (
                    <div className="mt-3 p-4 bg-blue-50 rounded-lg border border-blue-200">
                      <h4 className="text-sm font-semibold text-blue-900 mb-3">
                        Permisos del rol: {formData.role === 'superadmin' ? 'Super Administrador' : formData.role === 'admin' ? 'Administrador' : 'Usuario'}
                      </h4>
                      <div className="space-y-3">
                        {rolePermissions.map((section, idx) => (
                      ...
                      <p className="text-xs text-blue-700 mt-3 italic">
                        💡 Estos permisos se aplicarán automáticamente al asignar el rol
                      </p>
                    </div>
                  )}
                </div>
