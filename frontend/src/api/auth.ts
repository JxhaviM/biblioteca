...
export interface AuthResponse {
  ...
  message: string;
  token?: string;
  mustChangePassword?: boolean; // Indica si el usuario debe cambiar su contraseña
  isFirstLogin?: boolean; // Indica si es el primer login del usuario
  data?: {
    user: User;
    person: Person;
  };
...
export const authAPI = {
  ...
  // Actualizar permisos especiales de usuario
  updateUserPermissions: async (userId: string, permissions: { canChangeBookImages?: boolean }) => {
