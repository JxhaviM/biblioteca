...
const PermissionManagementPage: React.FC = () => {
  ...
  useEffect(() => {
    ...
    if (savedPerson) {
      try {
        setPerson(JSON.parse(savedPerson));
      } catch (error) {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-8">
          ...
          <p className="mt-2 text-gray-600">
            Administra permisos y roles del sistema para controlar el acceso de usuarios
          </p>
        </div>
              ...
              <div key={role._id} className="border rounded-lg p-4">
                <div className="flex justify-between items-start">
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-gray-500 mb-3">Nivel: {role.level}</p>
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white rounded-lg p-6 w-full max-w-md">
        <h3 className="text-lg font-semibold mb-4">Crear Permiso</h3>
